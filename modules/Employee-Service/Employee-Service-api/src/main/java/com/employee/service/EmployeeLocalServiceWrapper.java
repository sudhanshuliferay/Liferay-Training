...
public class EmployeeLocalServiceWrapper
	...
	@Override
	public com.employee.model.Employee getAllEmpByEmpIdDeptIdEname(
		long empid, String ename, int deptid) {

		return _employeeLocalService.getAllEmpByEmpIdDeptIdEname(
			empid, ename, deptid);
	}
	 ...
	 */
	@Override
	public java.util.List<com.employee.model.Employee> listAll() {
		return _employeeLocalService.listAll();
	}
