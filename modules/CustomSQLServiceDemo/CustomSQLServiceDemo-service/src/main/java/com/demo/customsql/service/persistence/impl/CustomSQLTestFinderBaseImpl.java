 ...
 * @generated
 */
public abstract class CustomSQLTestFinderBaseImpl
	extends BasePersistenceImpl<CustomSQLTest> {

	public CustomSQLTestFinderBaseImpl() {
	...
	public Set<String> getBadColumnNames() {
		return customSQLTestPersistence.getBadColumnNames();
	}
	...
	@Reference
	protected CustomSQLTestPersistence customSQLTestPersistence;

	private static final Log _log = LogFactoryUtil.getLog(
		CustomSQLTestFinderBaseImpl.class);
