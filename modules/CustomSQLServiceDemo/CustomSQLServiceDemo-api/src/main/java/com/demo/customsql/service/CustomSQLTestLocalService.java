...
/**
 * Provides the local service interface for CustomSQLTest. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see CustomSQLTestLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface CustomSQLTestLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.demo.customsql.service.impl.CustomSQLTestLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the custom sql test local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link CustomSQLTestLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public CustomSQLTest addCustomSQLTest(CustomSQLTest customSQLTest);
	...
	public CustomSQLTest createCustomSQLTest(long fooId);
	...
	public CustomSQLTest deleteCustomSQLTest(CustomSQLTest customSQLTest);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public CustomSQLTest deleteCustomSQLTest(long fooId) throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public CustomSQLTest fetchCustomSQLTest(long fooId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public CustomSQLTest fetchCustomSQLTestByUuidAndGroupId(
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public CustomSQLTest getCustomSQLTest(long fooId) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public CustomSQLTest getCustomSQLTestByUuidAndGroupId(
			String uuid, long groupId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<CustomSQLTest> getCustomSQLTests(int start, int end);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<CustomSQLTest> getCustomSQLTestsByUuidAndCompanyId(
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public CustomSQLTest updateCustomSQLTest(CustomSQLTest customSQLTest);
