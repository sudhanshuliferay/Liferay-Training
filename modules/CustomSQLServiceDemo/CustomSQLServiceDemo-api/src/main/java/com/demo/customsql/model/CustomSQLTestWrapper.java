...
/**
 * <p>
 * This class is a wrapper for {@link CustomSQLTest}.
 * </p>
 *
 ...
 * @generated
 */
public class CustomSQLTestWrapper
	extends BaseModelWrapper<CustomSQLTest>
	implements CustomSQLTest, ModelWrapper<CustomSQLTest> {

	public CustomSQLTestWrapper(CustomSQLTest customSQLTest) {
		super(customSQLTest);
	}
	...
	@Override
	protected CustomSQLTestWrapper wrap(CustomSQLTest customSQLTest) {
		return new CustomSQLTestWrapper(customSQLTest);
	}
