...
@Component(
	...
	property = {
		...
		"javax.portlet.display-name=CustomSQLDemo",
...
public class CustomSQLDemoPortlet extends MVCPortlet {
	...
	public void render(RenderRequest renderRequest, RenderResponse renderResponse)
		...
		//jdbc call
		/*
		 * try (Connection connection=DataAccess.getConnection()){ PreparedStatement
		 * preparedStatement= connection.prepareStatement("select * from user_");
		 * ResultSet resultSet=preparedStatement.executeQuery(); while
		 * (resultSet.next()) { String screenName=resultSet.getString("screenName");
		 * System.out.println("Screen name is : "+screenName); } } catch (SQLException
		...
		/*
		 * List<CustomSQLTest>
		 * users=customSQlTestService.findByScreenNameLikeUser("test_Sudhanshu");
