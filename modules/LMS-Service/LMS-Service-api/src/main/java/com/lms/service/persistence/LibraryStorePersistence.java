...
public interface LibraryStorePersistence extends BasePersistence<LibraryStore> {
	 ...
	 */
	public java.util.List<LibraryStore> findByUuid(String uuid);
	 ...
	 */
	public java.util.List<LibraryStore> findByUuid(
	 ...
	 * @return the matching library stores
	 */
	public java.util.List<LibraryStore> findByUuid_C(
	 ...
	 */
	public java.util.List<LibraryStore> filterFindByIssueDate(
		String issueDate, long groupId);
