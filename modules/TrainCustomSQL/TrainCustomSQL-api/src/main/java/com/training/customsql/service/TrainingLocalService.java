...
public interface TrainingLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.training.customsql.service.impl.TrainingLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the training local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link TrainingLocalServiceUtil} if injection and service tracking are not available.
	 */
